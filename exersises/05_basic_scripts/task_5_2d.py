...
devname = input('Enter device name (r1, r2, sw1): ')
devparam = input('Enter parameter name (ios,model,vendor,location,ip): ')

devn = london_co[devname]

print(devn.get(devparam.lower(), 'No such parametr'))
